...
import { Team } from "./TeamClients";

async function getData() {
  const data = await client.fetch('*[_type=="teamone"]');
  return data;
}
    ...
    <div className="w-full flex justify-center bg-white py-10 lg:pt-10 pb-20">
      <div className="w-full max-w-[1124px] flex flex-col gap-20 mt-12 sm:mt-8 md:ml-12 sm:px-4 ">
        ...
        <div className="text-center max-w-lg mx-auto ">
          <h2 className="text-4xl font-bold text-[#252B42] text-center">
            Meet Our Team
          </h2>
          <p className="text-base text-[#737373] mt-4 text-center">
